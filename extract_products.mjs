...
const collectionUrls = [
  "https://kiokii.com/collections/sheet-masks?page=4",
  "https://kiokii.com/collections/sheet-masks?page=5",
  "https://kiokii.com/collections/sheet-masks?page=6",
  "https://kiokii.com/collections/sheet-masks?page=7",
];
...
for (const collectionUrl of collectionUrls) {
  ...
  for (const match of html.matchAll(/<a\b[^>]*href=["']([^"']*\/collections\/sheet-masks\/products\/[^"']*)["'][^>]*>/gi)) {
